...
Displays the average customer rating for different product categories.
Food and Beverages has the highest rating (7.1), while Home and Lifestyle has the lowest (6.8).

- Step 2 : ***Revenue by City***:

A pie chart representing the revenue share from three cities: Yangon (33%), Mandalay (33%), and Naypyitaw (34%).
Naypyitaw contributes the highest revenue.

- Step 3 : ***Most Used Payment Method***:

Displays the number of transactions completed using different payment methods.
E-wallet (345 transactions) is the most preferred, followed by Cash (344) and Credit Card (311).

- Step 4 : ***Sales Trend Over Time***:

A time series line chart representing daily sales trends over three months.
Peaks and dips indicate fluctuating demand and potential seasonality in sales.

- Step 5 : ***Most Selling Products by City***:

A horizontal bar chart showing the top-selling product categories in Yangon, Mandalay, and Naypyitaw.
Sports & Travel and Food & Beverages have higher sales in most cities.

- Step 6 : ***Products by Gross Income***:

A vertical bar chart showing revenue generated by each product category.
Food & Beverages is the highest revenue-generating category (2,674), while Health & Beauty has the lowest (2,343).

- Step 7 : ***Products by Total Sales & Quantity Sold***:

Combination chart with bar and line graphs.
The total sales revenue (bar) and number of units sold (line) are compared for different product categories.
